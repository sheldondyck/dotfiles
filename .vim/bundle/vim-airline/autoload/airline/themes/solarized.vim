...
function! airline#themes#solarized#refresh()
  ...
  let s:base0   = {'t': s:ansi_colors ?  12 : (s:tty ? '8' : 244), 'g': '#839496'}
  let s:base1   = {'t': s:ansi_colors ?  14 : (s:tty ? '8' : 245), 'g': '#93a1a1'}
  let s:base2   = {'t': s:ansi_colors ?   7 : (s:tty ? '8' : 254), 'g': '#eee8d5'}
  let s:base3   = {'t': s:ansi_colors ?  15 : (s:tty ? '8' : 230), 'g': '#fdf6e3'}
